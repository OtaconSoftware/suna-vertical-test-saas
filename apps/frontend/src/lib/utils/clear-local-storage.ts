export const clearUserLocalStorage = () => {
  ...
  try {
    ...
    // localStorage.removeItem('breakit-preferred-model-v3');
    localStorage.removeItem('customModels');
    localStorage.removeItem('breakit-model-selection-v2');
    ...
    localStorage.removeItem('breakit_upgrade_dialog_displayed');
