...
// localStorage keys
const SELECTED_MODE_KEY = 'selectedBreakitMode';
...
export function useBreakitModePersistence(): BreakitModesState & BreakitModesActions {
