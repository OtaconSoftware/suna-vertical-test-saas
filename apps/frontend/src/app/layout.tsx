...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Otacon Team', url: 'https://www.otacon.com' }],
  creator: 'Otacon Team',
  publisher: 'Otacon Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>Otacon: Your Autonomous AI Worker</title>
        ...
        <meta name="keywords" content="Otacon, AI Worker, Agentic AI, Autonomous AI Worker, AI Automation, AI Workflow Automation, AI Assistant, Task Automation" />
        <meta property="og:title" content="Otacon: Your Autonomous AI Worker" />
        ...
        <meta property="og:image" content="https://otacon.com/banner.png" />
        <meta property="og:url" content="https://otacon.com" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Otacon" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Otacon: Your Autonomous AI Worker" />
        ...
        <meta name="twitter:image" content="https://otacon.com/banner.png" />
        <meta name="twitter:site" content="@otacon" />
        <link rel="canonical" href="https://otacon.com" />
        
        {/* iOS Smart App Banner - shows native install banner in Safari */}
        {!featureFlags.disableMobileAdvertising ? (
          <meta name="apple-itunes-app" content="app-id=6754448524, app-argument=otacon://" />
        ) : null}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['Otacon', 'Otacon AI', 'Otacon: Your Autonomous AI Worker'],
              url: siteMetadata.url,
              logo: `${siteMetadata.url}/favicon.png`,
              description: siteMetadata.description,
              foundingDate: '2024',
              sameAs: [
                'https://github.com/Otacon-ai/Breakit',
                'https://x.com/otacon',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'Otacon'],
