...
interface Slide {
  ...
  bulletPoints?: string[];
  accent?: string;
  diagram?: 'agent-loop' | 'otacon-stack' | 'task-types' | 'token-flow' | 'messages-array' | 'sandbox-arch' | 'tools-overview';
...
const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitle: 'CEO & COO at Otacon',
  },
  {
    id: 3,
    type: 'title',
    title: 'Demo',
    subtitle: 'Let\'s see Otacon in action',
  },
...
// Otacon Stack Diagram
const OtaconStackDiagram = () => {
  const layers = [
      ...
      {slide.type === 'diagram' && (
        <div className="w-full max-w-4xl">
          ...
          >
            ...
            {slide.diagram === 'otacon-stack' && <OtaconStackDiagram />}
