...
const OtaconLoader = lazy(() => import('@/components/ui/otacon-loader').then(mod => ({ default: mod.OtaconLoader })));
                ...
                <CardContent className="p-6 h-full">
                  <div className="flex items-center justify-between h-full">
                    ...
                    <div className="h-12 w-12 flex items-center justify-center">
                      <Suspense fallback={<OtaconLoader size="small" />}>
                        <OtaconLoader size="small" customSize={24} />
                      </Suspense>
                    </div>
                  </div>
                </CardContent>
