...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Otacon',
    description: 'Replay this Worker conversation on Otacon',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Otacon';
    const description =
      projectData.description ||
      'Replay this Worker conversation on Otacon';
