...
interface OtaconComputerHeaderProps {
...
/**
 * Shared header component for all Otacon Computer views (Files, File Viewer, Browser).
 ...
 */
export function OtaconComputerHeader({
  icon: Icon,
  onIconClick,
  iconTitle,
  title,
