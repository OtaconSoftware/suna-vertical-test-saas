...
const OtaconAppBanners = lazy(() => 
  import('@/components/announcements/otacon-app-banners').then(mod => ({ default: mod.OtaconAppBanners }))
);
  ...
  return (
    ...
    >
      <div className="relative h-full">
        ...
        {/* Otacon App announcement banners */}
        <Suspense fallback={null}>
          <OtaconAppBanners disableMobileAdvertising={featureFlags.disableMobileAdvertising} />
        </Suspense>
